	...
	public Customer fundTransfer(String sourcePhone, String targetPhone, BigDecimal balance) throws PaymentWalletException {
		...
		try{
			...
			preparedStmt2.executeUpdate();	
					...
					String sql12 = "SELECT * from PaymentWalletTransactions WHERE phoneNumber=?";
					...
					int row4=pstmt4.executeUpdate();
							...
							String sql10 = "SELECT * from PaymentWalletTransactions WHERE phoneNumber=?";
							...
							String sql11 = "UPDATE PaymentWalletTransactions SET statement = ? WHERE phoneNumber = ?";
...
Wallet wall1=wall.getWallet();
	...
	public String printTransaction(String phone) throws PaymentWalletException {
		String str1=null;
		try{
			String sql1="SELECT * from PaymentWalletTransactions WHERE phoneNumber=?";
